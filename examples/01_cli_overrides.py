...
Try a few of these from the repo root:
    ...
    python examples/01_cli_overrides.py
    python examples/01_cli_overrides.py epochs=20 lr=0.001
    python examples/01_cli_overrides.py model.hidden_size=1024 --show
    python examples/01_cli_overrides.py optimizer.kind=sgd
